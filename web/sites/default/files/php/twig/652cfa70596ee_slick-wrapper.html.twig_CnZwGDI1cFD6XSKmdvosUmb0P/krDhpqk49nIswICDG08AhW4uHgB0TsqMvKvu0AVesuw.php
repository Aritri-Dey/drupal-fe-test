...
class __TwigTemplate_0fc423155c47afbcefa3475a31f31698 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 16
        $context["classes"] = [0 => "slick-wrapper", 1 => ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 18
($context["blazies"] ?? null), "is", [], "any", false, false, true, 18), "nav", [], "any", false, false, true, 18)) ? ("slick-wrapper--asnavfor") : ("")), 2 => ((twig_get_attribute($this->env, $this->source,         // line 19
...
{% else %}
  {{- items -}}
{%- endif -%}
", "modules/contrib/slick/templates/slick-wrapper.html.twig", "/var/www/drupalfe.com/web/modules/contrib/slick/templates/slick-wrapper.html.twig");
    }
